...
:: d) "http://srv2k3:8000/" with the name of the site you wish to publish to
...
::stsadm -o deactivatefeature -filename MyFeature\feature.xml -url http://srv2k3:8000/
::stsadm -o uninstallfeature -filename MyFeature\feature.xml

stsadm -o installfeature -filename MyFeature\feature.xml -force
stsadm -o activatefeature -filename MyFeature\feature.xml -url http://srv2k3:8000/
